        ...
        <div className="container max-w-6xl mx-auto">
          ...
          {(tab === "all" || tab === "videos") && (
            <>
              ...
              {/* Videos keep native 16/9 — simple responsive grid */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
                {(tab === "all" ? videos : filtered.filter(m => m.type === "video")).map((item, i) => (
                  ...
                  >
                    {/* let the video define its own natural height */}
                    <video
                      src={item.src}
                      ...
                      style={{ display: "block" }}
                    />
                    <div className="absolute inset-0" style={{ background: "rgba(6,13,28,0.22)" }} />
          ...
          {/* Photos section — CSS columns masonry so every image shows at its natural height */}
          {(tab === "all" || tab === "photos") && (
            <>
              {tab === "all" && (
                <div className="flex items-center gap-3 mb-5">
              ...
              <style>{`
                .photo-masonry { column-count: 2; column-gap: 12px; }
                @media (min-width: 640px)  { .photo-masonry { column-count: 3; } }
                @media (min-width: 1024px) { .photo-masonry { column-count: 4; } }
              `}</style>
