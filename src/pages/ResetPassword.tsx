...
// !! Same URL as ForgotPassword.tsx !!
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .rp-err-link {display:inline-block;padding:11px 24px;background:linear-gradient(135deg,${GOLD},${GOLD2});color:${NAVY};font-weight:800;border-radius:10px;text-decoration:none;font-size:13px}
        ...
        <div className="rp-card">
          ...
          {tokenErr ? (
            <div className="rp-err-box">
              ...
              <Link to="/forgot-password" className="rp-err-link">Request New Link →</Link>
            </div>
