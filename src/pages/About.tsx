  ...
  return (
    <MainLayout>
      ...
      <section
        ...
        style={{ background: `linear-gradient(135deg,#060d1c 0%,${NAVY} 55%,${NAVY2} 100%)`, minHeight: "88vh" }}
      >
        {/* grid bg */}
        ...
        <div className="container relative z-10 flex flex-col lg:flex-row items-center gap-0 lg:gap-16 min-h-[88vh] py-16 md:py-0">

          {/* left — text */}
          <motion.div
            className="flex-1 text-center lg:text-left py-12 lg:py-24"
          ...
          <motion.div
            className="flex-1 w-full flex items-center justify-center pb-12 lg:pb-0"
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 relative z-10">
              ...
              {/* image pair */}
              <div className="relative flex items-end justify-center gap-3 px-8 pt-10 pb-0 lg:pb-10">
                {/* main photo */}
                <motion.div
                ...
                >
                  <div className="rounded-2xl overflow-hidden w-52 h-64 border-2"
                  ...
                  {/* gold accent corner */}
                  <div className="absolute -bottom-2 -left-2 w-8 h-8 rounded-lg"
                    style={{ background: `linear-gradient(135deg,${GOLD},${GOLD2})` }} />
                </motion.div>
                ...
                >
                  <div className="rounded-2xl overflow-hidden w-40 h-52 border"
              ...
              <div className="flex flex-col justify-center px-8 lg:px-12 py-10 lg:py-16">
                ...
                {/* quote block */}
                <div className="relative pl-5 mb-6 border-l-2" style={{ borderColor: GOLD }}>
                  <Quote size={18} style={{ color: GOLD, opacity: 0.5 }} className="absolute -top-1 -left-2" />
