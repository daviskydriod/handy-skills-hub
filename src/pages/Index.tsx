...
const SLIDES = [
  {
    // Desola Lanre-Ologun — Lagos, Nigeria — Black man & woman learning to code together
  ...
  {
    // Oluwakemi Solaja — Covenant University, Ota, Nigeria — Nigerian students studying
  ...
  {
    // Emmanuel Ikwuegbu — Port Harcourt, Nigeria — Nigerian classroom students
